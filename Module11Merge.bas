...
Attribute VB_Name = "Module1"
  Sub Tickerlooping()
    ...
    For Each CurrentWs In Worksheets
        ...
        ' Set new variables for  Solution Part 1
        ...
        Delta_Percent = 0
        ' Set new variables for Solution Part 2
        ...
        ' Track of the location for each ticker name
...
>>>>>>> 6ed2a0e211e76d3b7c4b0cf5ca7464eba2e17faa
